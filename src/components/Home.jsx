            ...
            >
                ...
                >
                    ...
                    <Typewriter
                        ...
                        <Button as={Link} _hover={{"text-decoration":"none"}} cursor={"pointer"} href={pdf} target="_blank"
                id="resume-button-2" download={true} rightIcon={<ViewIcon />} color={"#EEEEEE"} mt={5} colorScheme='teal' onClick={()=>{
                    window.open(
